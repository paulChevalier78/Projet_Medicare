...
<head>
    ...
    <script src="votre_compte.js"></script>
</head>
<body>
    <div class="wrapper">
        ...
        <div id="compteAdministrateur">
            <h2>Connexion</h2>
            <form id="formMedecin" action="login_medecin.php" method="post">
                <div class="form-group">
                    <label for="nomMedecin">Nom:</label>
                    <input type="text" class="form-control" id="nomMedecin" name="nom" placeholder="Entrez votre nom">
                </div>
                <div class="form-group">
                    <label for="prenomMedecin">Prénom:</label>
                    <input type="text" class="form-control" id="prenomMedecin" name="prenom" placeholder="Entrez votre prénom">
                </div>
                <div class="form-group">
                    <label for="emailMedecin">Courriel:</label>
                    <input type="email" class="form-control" id="emailMedecin" name="email" placeholder="Entrez votre courriel">
                </div>
