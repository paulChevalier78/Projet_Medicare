...
<body>
    <div class="wrapper">
        ...
        <div class="container">
            ...
            <ul id="liste-specialites">
                <li><a href="#" onclick="afficherMedecins('Addictologue')">Addictologie</a></li>
                <li><a href="#" onclick="afficherMedecins('Andrologie')">Andrologie</a></li>
                <li><a href="#" onclick="afficherMedecins('Cardiologie')">Cardiologie</a></li>
                <li><a href="#" onclick="afficherMedecins('Dermatologie')">Dermatologie</a></li>
                <li><a href="#" onclick="afficherMedecins('Gastro-Hépato-Entérologie')">Gastro-Hépato-Entérologie</a></li>
                <li><a href="#" onclick="afficherMedecins('Gynécologie')">Gynécologie</a></li>
                <li><a href="#" onclick="afficherMedecins('I.S.T.')">I.S.T.</a></li>
                <li><a href="#" onclick="afficherMedecins('Ostéopathie')">Ostéopathie</a></li>
            </ul>
        </div>
