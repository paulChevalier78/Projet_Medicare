        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-md-4 text-center">
                    <img src="medecin1.png" alt="Dr Julia Molinari" class="img-fluid mb-3">
                    <div>
                        <a href="cvmedecin1.png" class="btn btn-primary mb-2 d-inline-block">Voir son CV</a>
                        <a href="dispo1.php" class="btn btn-success mb-2 d-inline-block">Prendre un RDV</a>
                        <a href="com.html" class="btn btn-info mb-2 d-inline-block">Communiquer avec le médecin</a>
                    </div>
                </div>
                <div class="col-md-8">
                    <h1>Dr Julia Molinari</h1>
