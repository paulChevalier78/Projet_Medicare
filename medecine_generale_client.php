    ...
    <nav class="navbar navbar-expand-md">
        ...
        <div class="container">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr>
                        <td><a href="medecing1_client.php">Molinari</a></td>
                        <td><a href="medecing1_client.php">Julia</a></td>
                    </tr>
                    <tr>
                        <td><a href="medecing2_client.php">Martin</a></td>
                        <td><a href="medecing2_client.php">Anne</a></td>
                    </tr>
                    <tr>
                        <td><a href="medecing3_client.php">Bernard</a></td>
                        <td><a href="medecing3_client.php">Luc</a></td>   
                    </tr>
                    <tr>
                        <td><a href="medecing4_client.php">Dubois</a></td>
                        <td><a href="medecing4_client.php">Marie</a></td>
                    </tr>
                    <tr>
                        <td><a href="medecing5_client.php">Thomas</a></td>
                        <td><a href="medecing5_client.php">Paul</a></td>
                    </tr>
                </tbody>
            </table>
        </div>
