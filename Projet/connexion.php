...
try {
    ...
    if(isset($_POST['username']) && isset($_POST['password'])){
        ...
        // Requête SQL pour rechercher l'utilisateur dans la table clients
        $requete_client = $connexion->prepare("SELECT * FROM patients WHERE email = :email AND mdp = :mdp");
        ...
        if($client){
            // Si l'utilisateur est un client, retourner un message de succès
