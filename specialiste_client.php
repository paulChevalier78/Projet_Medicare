    ...
    <div class="wrapper">
        ...
        <div class="container">
            ...
            <ul id="liste-specialites">
                <li><a href="#" onclick="afficherMedecin('Addictologue')">Addictologie</a></li>
                <li><a href="#" onclick="afficherMedecin('Andrologie')">Andrologie</a></li>
                <li><a href="#" onclick="afficherMedecin('Cardiologie')">Cardiologie</a></li>
                <li><a href="#" onclick="afficherMedecin('Dermatologie')">Dermatologie</a></li>
                <li><a href="#" onclick="afficherMedecin('Gastro-Hépato-Entérologie')">Gastro-Hépato-Entérologie</a></li>
                <li><a href="#" onclick="afficherMedecin('Gynécologie')">Gynécologie</a></li>
                <li><a href="#" onclick="afficherMedecin('I.S.T.')">I.S.T.</a></li>
                <li><a href="#" onclick="afficherMedecin('Ostéopathie')">Ostéopathie</a></li>
            </ul>
        </div>
