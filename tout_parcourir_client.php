    ...
    <div class="wrapper">
        ...
        <div class="container">
            <div class="row align-items-start">
                <div class="col">
                <a href="#" onclick="afficherMedecin('Généraliste')"><h3>Médecine générale</h3></a>
                </div>
                <div class="col">
                    <a href="specialiste_client.php"><h3>Médecins spécialistes</h3></a>
                </div>
                <div class="col">
                <a href="LabBioMed_client.html"><h3>Laboratoire biologie médicale</h3></a>
                </div>
            </div>
        </div>
