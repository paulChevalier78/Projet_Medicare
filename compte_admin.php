<?php
    ...
    try {
        ...
        if(isset($_POST['nom']) && isset($_POST['prenom']) && isset($_POST['contact']) && isset($_POST['email'])&& isset($_POST['mdp']) && isset($_POST['cv']) && isset($_POST['photo'])){
           // Récupérer les valeurs du formulaire
            ...
            $requete_insertion = $connexion->prepare("INSERT INTO medecins (nom, prenom, contact, email, mdp, photo, cv)");
            ...
            $requete_insertion->bindParam(':photo', $photo); // Liaison du numéro de sécurité sociale
...
<head>
    ...
    <script src="compte_admin.js"></script>
        ...
        <div class="container_compte">
            <div class="container">
                <div class="text-center">
                    <h3>Binevenue sur le compte administrateur</h3>
                </div>
            </div>            
                <div class="text-center mb-3">
                    <a href="ajouter_medecin.php" class="btn btn-primary mr-3">Ajouter un médecin</a>
                    <a href="supprimer_medecin.php" class="btn btn-success mr-3">Supprimer un médecin</a>
                    <a href="creer_fichier_xml.php" class="btn btn-primary">Créer fichier XML</a>
                </div>
