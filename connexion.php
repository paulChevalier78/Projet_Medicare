    ...
    <div class="wrapper">
        ...
        <div class="container text-center">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        <img src="doctor.png" class="card-img-top" alt="Médecin">
                        <div class="card-body">
                            <h5 class="card-title">Médecin</h5>
                            <a href="connexion_medecin.php" class="btn btn-primary">Accéder</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <img src="patient.png" class="card-img-top" alt="Patient">
                        <div class="card-body">
                            <h5 class="card-title">Patient</h5>
                            <a href="connexion_client.php" class="btn btn-primary">Accéder</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <img src="admin.png" class="card-img-top" alt="Administrateur">
                        <div class="card-body">
                            <h5 class="card-title">Administrateur</h5>
                            <a href="connexion_admin.php" class="btn btn-primary">Accéder</a>
                        </div>
                    </div>
                </div>
            </div>
